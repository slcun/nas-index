...
// IsSystemdAvailable 返回系统是否使用 systemd
...
// systemctlAction 执行 systemctl 管理操作
func systemctlAction(name, action string) (bool, string) {
...
func startService(name string) (bool, string)   { return systemctlAction(name, "start") }
func stopService(name string) (bool, string)    { return systemctlAction(name, "stop") }
func restartService(name string) (bool, string) { return systemctlAction(name, "restart") }
